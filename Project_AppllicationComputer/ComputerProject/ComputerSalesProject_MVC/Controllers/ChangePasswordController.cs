...
namespace ComputerSalesProject_MVC.Controllers
{
    public class ChangePasswordController : Controller
    {
        ...
        public ChangePasswordController(ForgotRequestOtp_UC fpRequest, ForgotVerifyOtp_UC fpVerify, ForgotResetPassword_UC fpReset)
        {
        ...
        public IActionResult ChangePassswordHome()
        {
            return View();
        }
