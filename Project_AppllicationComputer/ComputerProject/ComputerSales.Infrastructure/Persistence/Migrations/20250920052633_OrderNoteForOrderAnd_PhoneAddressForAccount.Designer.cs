...
namespace ComputerSales.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20250920052633_OrderNoteForOrderAnd_PhoneAddressForAccount")]
    partial class OrderNoteForOrderAnd_PhoneAddressForAccount
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("ComputerSales.Domain.Entity.E_Order.Order", b =>
                {
                    ...
                    b.ToTable("Order", null, t =>
                        {
                            t.HasCheckConstraint("CK_Orders_OrderStatus_ValidRange", "[OrderStatus] BETWEEN 0 AND 5");
                        });
                });
